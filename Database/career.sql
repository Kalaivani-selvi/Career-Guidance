...
INSERT INTO `users` (`id`, `email`, `password`, `security_answer`, `name`, `photo_path`, `r1_score`, `r2_score`, `r3_score`, `r4_score`) VALUES
(2, 'kalai@gmail.com', 'Niki', 'pasta', 'Nikitha M', 'but2.jpg', '6', '2', '4', ''),
(3, 'kalaivani.m7@jkkn.ac.in', 'niki', 'lisa', '', '', '', '', '', '');
